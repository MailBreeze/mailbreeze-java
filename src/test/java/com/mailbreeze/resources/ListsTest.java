...
class ListsTest {
  ...
  class CreateTests {
    ...
    void shouldCreateList() throws Exception {
      ...
      assertThat(request.getPath()).isEqualTo("/api/v1/contact-lists");
    }
  ...
  class ListTests {
    ...
    @Test
    @DisplayName("should list contact lists")
    void shouldListLists() throws Exception {
      ...
      Lists.ListsResponse response = lists.list();

      assertThat(response).isNotNull();
      assertThat(response.getData()).hasSize(2);
      assertThat(response.getData().get(0).getName()).isEqualTo("Newsletter");
      assertThat(response.getData().get(0).getContactCount()).isEqualTo(1500);
    ...
    void shouldListWithSearch() throws Exception {
      ...
      ListListsParams params = ListListsParams.builder().search("news").limit(10).build();
  ...
  class GetTests {
    ...
    void shouldGetListById() throws Exception {
      ...
      RecordedRequest request = mockServer.takeRequest();
      assertThat(request.getMethod()).isEqualTo("GET");
      assertThat(request.getPath()).isEqualTo("/api/v1/contact-lists/list_xyz789");
    }
  }
  ...
  class UpdateTests {
    ...
    void shouldUpdateList() throws Exception {
      ...
      UpdateListParams params =
          UpdateListParams.builder().name("Updated Name").description("New description").build();
      ...
      assertThat(request.getPath()).isEqualTo("/api/v1/contact-lists/list_123");
    }
  }
  ...
  class StatsTests {
    ...
    void shouldGetStats() throws Exception {
      ...
      RecordedRequest request = mockServer.takeRequest();
      assertThat(request.getMethod()).isEqualTo("GET");
      assertThat(request.getPath()).isEqualTo("/api/v1/contact-lists/list_123/stats");
    }
  }
}
