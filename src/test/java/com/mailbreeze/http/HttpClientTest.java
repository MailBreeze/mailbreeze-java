...
class HttpClientTest {
  ...
  class GetRequestTests {
    ...
    void shouldSendGetRequest() throws Exception {
      ...
      assertThat(request.getPath()).isEqualTo("/api/v1/emails/email_123");
    }
  ...
  class PostRequestTests {
    ...
    void shouldIncludeIdempotencyKey() throws Exception {
      ...
      RequestOptions options = RequestOptions.builder().idempotencyKey("unique-key-123").build();
    ...
    void shouldPreventHeaderInjection() throws Exception {
      ...
      RequestOptions options =
          RequestOptions.builder().idempotencyKey("key\r\nEvil-Header: evil-value").build();
  ...
  class PatchRequestTests {
    ...
    void shouldSendPatchRequest() throws Exception {
      ...
      JsonNode result =
          httpClient.patch("/lists/lst_123", Map.of("name", "Updated"), JsonNode.class);
  ...
  class DeleteRequestTests {
    ...
    void shouldSendDeleteRequest() throws Exception {
      ...
      assertThat(request.getPath()).isEqualTo("/api/v1/lists/lst_123");
    }
  }
  ...
  class AsyncTests {
    ...
    void postAsyncShouldReturnFuture() throws Exception {
      ...
      CompletableFuture<JsonNode> future =
          httpClient.postAsync("/emails", Map.of("test", true), JsonNode.class, null);
