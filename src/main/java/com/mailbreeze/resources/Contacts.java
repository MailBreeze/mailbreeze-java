 ...
 *
 * <p>Contacts are list-scoped, meaning you need to specify a list ID to work with contacts.
 * Use {@link com.mailbreeze.MailBreeze#contacts(String)} to get a Contacts instance for a specific list.</p>
 *
 * <p>Example usage:</p>
 * <pre>{@code
...
public class Contacts extends BaseResource {
    ...
    /**
     * Builds the path including the list ID.
     * Overrides the base path building to include: /contact-lists/{listId}/contacts{path}
     */
    @Override
    ...
    public PaginatedResponse<Contact> list(ListContactsParams params) {
        Map<String, String> queryParams = params != null ? params.toQueryParams() : null;
        return (PaginatedResponse<Contact>) get("", queryParams, ContactPaginatedResponse.class);
    }
     ...
     *
     * <p>Suppressed contacts will not receive any emails.</p>
     *
    ...
    /**
     * Concrete type for deserializing paginated contact responses.
     */
    public static class ContactPaginatedResponse extends PaginatedResponse<Contact> {
    }
}
