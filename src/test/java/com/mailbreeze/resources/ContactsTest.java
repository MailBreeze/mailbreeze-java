...
class ContactsTest {
    ...
    class PathBuildingTests {
        ...
        void shouldIncludeListIdInPath() throws Exception {
            ...
            assertThat(request.getPath()).startsWith("/contact-lists/list_abc123/contacts");
        }
    }
    ...
    class CreateTests {
        ...
        void shouldCreateContact() throws Exception {
            ...
            CreateContactParams params = CreateContactParams.builder()
                    .email("john@example.com")
                    .firstName("John")
                    .lastName("Doe")
                    .build();
            ...
            assertThat(request.getPath()).isEqualTo("/contact-lists/list_abc123/contacts");
        }
    ...
    class ListTests {
        ...
        void shouldListContacts() throws Exception {
            ...
            PaginatedResponse<Contact> response = contacts.list();

            assertThat(response).isNotNull();
            assertThat(response.getItems()).hasSize(2);
            assertThat(response.getItems().get(0).getEmail()).isEqualTo("alice@example.com");
            assertThat(response.getItems().get(1).getStatus()).isEqualTo(ContactStatus.UNSUBSCRIBED);
        ...
        void shouldListWithFilters() throws Exception {
            ...
            ListContactsParams params = ListContactsParams.builder()
    ...
    class GetTests {
        ...
        void shouldGetContactById() throws Exception {
            ...
            RecordedRequest request = mockServer.takeRequest();
            assertThat(request.getMethod()).isEqualTo("GET");
            assertThat(request.getPath()).isEqualTo("/contact-lists/list_abc123/contacts/contact_xyz789");
        }
    }
    ...
    class UpdateTests {
        ...
        void shouldUpdateContact() throws Exception {
            ...
            UpdateContactParams params = UpdateContactParams.builder()
                    .email("updated@example.com")
                    .firstName("Updated")
                    .build();
            ...
            assertThat(request.getPath()).isEqualTo("/contact-lists/list_abc123/contacts/contact_123");
        }
    }
    ...
    class SuppressTests {
        ...
        void shouldSuppressContact() throws Exception {
            ...
            RecordedRequest request = mockServer.takeRequest();
            assertThat(request.getMethod()).isEqualTo("POST");
            assertThat(request.getPath()).isEqualTo("/contact-lists/list_abc123/contacts/contact_123/suppress");
