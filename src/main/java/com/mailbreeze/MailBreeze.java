 ...
 *
 * <p>Use the builder to create a client instance:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>The client is thread-safe and should be reused across your application.
 */
public final class MailBreeze {
   ...
   *
   * <p>Contacts are list-scoped, so you need to specify which list to work with.
   *
