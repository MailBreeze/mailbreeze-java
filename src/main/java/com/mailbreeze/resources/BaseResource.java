 ...
 * Provides common HTTP methods with path building for resource endpoints.
 *
 * <p>Each resource subclass defines a base path (e.g., "/emails", "/contacts")
 * and all requests are automatically prefixed with this path.</p>
 *
